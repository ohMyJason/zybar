    ...
    return function (t) {
        ...
        var s = {
            leftDistance: function (t) {
                ...
                var e = parseInt(t / 60), n = parseInt(t % 60);
        ...
        }, i = !1, a = "http://120.79.36.48/", l = function () {
            function t(e) {
                var n = this;
                if (o(this, t), i) return console.error("SKPlayer鍙兘瀛樺湪涓€涓疄渚嬶紒"), Object.create(null);
                i = !0;
                ...
                if (this.option = e, !(this.option.music && this.option.music.type && this.option.music.source)) return console.error("璇锋纭厤缃璞★紒"), Object.create(null);
                this.root = this.option.element, this.type = this.option.music.type, this.music = this.option.music.source, this.isMobile = /mobile/i.test(window.navigator.userAgent), this.toggle = this.toggle.bind(this), this.toggleList = this.toggleList.bind(this), this.toggleMute = this.toggleMute.bind(this), this.switchMode = this.switchMode.bind(this), "file" === this.type ? (this.root.innerHTML = this.template(), this.init(), this.bind()) : "cloud" === this.type && (this.root.innerHTML = '<p class="skPlayer-tip-loading">LOADING</p>', s.ajax({
                    ...
                    beforeSend: function () {
                        console.log("SKPlayer姝ｅ湪鍔姏鐨勬媺鍙栨瓕鍗� ...")
                    },
                    success: function (t) {
                        console.log("姝屽崟鎷夊彇鎴愬姛锛�"), n.music = JSON.parse(t), n.root.innerHTML = n.template(), n.init(), n.bind()
                    },
                    fail: function (t) {
                        console.error("姝屽崟鎷夊彇澶辫触锛� 閿欒鐮侊細" + t)
                    }
                }))
            }
            ...
            return r(t, [{
                ...
                key: "init", value: function () {
                    ...
                    this.dom = {
                        ...
                        beforeSend: function () {
                            console.log("SKPlayer姝ｅ湪鍔姏鐨勬媺鍙栨瓕鏇� ...")
                        },
                        success: function (e) {
                            var n = JSON.parse(e).url;
                            null !== n ? (console.log("姝屾洸鎷夊彇鎴愬姛锛�"), t.audio.src = n) : (console.log("姝屾洸鎷夊彇澶辫触锛� 璧勬簮鏃犳晥锛�"), 1 !== t.music.length && t.next())
                        },
                        fail: function (t) {
                            console.error("姝屾洸鎷夊彇澶辫触锛� 閿欒鐮侊細" + t)
                        }
                    })
                }
            }, {
                key: "bind", value: function () {
                    ...
                    this.updateLine = function () {
                        ...
                        if ("LI" === e.target.tagName.toUpperCase()) n = e.target; else {
                ...
                key: "switchMusic", value: function (t) {
                    var e = this;
                    return "number" != typeof t ? void console.error("璇疯緭鍏ユ纭殑姝屾洸搴忓彿锛�") : (t -= 1) < 0 || t >= this.music.length ? void console.error("璇疯緭鍏ユ纭殑姝屾洸搴忓彿锛�") : t == this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index") ? void this.play() : (this.dom.musiclist.querySelector(".skPlayer-curMusic").classList.remove("skPlayer-curMusic"), this.dom.musicitem[t].classList.add("skPlayer-curMusic"), this.dom.name.innerHTML = this.music[t].name, this.dom.author.innerHTML = this.music[t].author, this.dom.cover.src = this.music[t].cover, void ("file" === this.type ? (this.audio.src = this.music[t].src, this.play()) : "cloud" === this.type && s.ajax({
                        ...
                        success: function (t) {
                            ...
                            null !== n ? (console.log("姝屾洸鎷夊彇鎴愬姛锛�"), e.audio.src = n, e.play()) : (console.log("姝屾洸鎷夊彇澶辫触锛� 璧勬簮鏃犳晥锛�"), 1 !== e.music.length && e.next())
                        },
                        fail: function (t) {
                            console.error("姝屾洸鎷夊彇澶辫触锛� 閿欒鐮侊細" + t)
                        }
                ...
                key: "destroy", value: function () {
                    ...
                    console.log("璇ュ疄渚嬪凡閿€姣侊紝鍙噸鏂伴厤缃� ...")
                }
            }]), t
        }();
        t.exports = l
        ...
        function r(t, e) {
            for (var n = [], o = {}, r = 0; r < t.length; r++) {
                var s = t[r], i = e.base ? s[0] + e.base : s[0], a = s[1], l = s[2], c = s[3],
        ...
        function s(t, e) {
            ...
            var o = P[P.length - 1];
            if ("top" === t.insertAt) o ? o.nextSibling ? n.insertBefore(e, o.nextSibling) : n.appendChild(e) : n.insertBefore(e, n.firstChild), P.push(e); else {
        ...
        function d(t, e, n, o) {
            ...
            if (t.styleSheet) t.styleSheet.cssText = v(e, r); else {
                var s = document.createTextNode(r), i = t.childNodes;
        ...
        function h(t, e, n) {
            var o = n.css, r = n.sourceMap, s = void 0 === e.convertToAbsoluteUrls && r;
            (e.convertToAbsoluteUrls || s) && (o = g(o)), r && (o += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(r)))) + " */");
            var i = new Blob([o], {type: "text/css"}), a = t.href;
